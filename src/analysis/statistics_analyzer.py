...
class StatisticsAnalyzer:
    ...
    def get_productivity_by_hour(self, days: int = 30) -> Dict[int, float]:
        ...
        sessions = self.data_manager.get_all_sessions(start_date, datetime.now())
        ...
        for session in sessions:
            ...
            if stats['total_duration_minutes'] > 0:
                productivity = stats['total_activity_count'] / stats['total_duration_minutes']
    ...
    def get_best_work_hours(self, days: int = 30) -> List[int]:
        ...
        sorted_hours = sorted(hourly_prod.items(), key=lambda x: x[1], reverse=True)
    ...
    def _calculate_stats(self, start_date: datetime, end_date: datetime) -> Dict:
        ...
        total_time = sum(s.get_stats()['total_duration_minutes'] for s in sessions)
