...
class AchievementManager:
    ...
    def __init__(self, achievements_file: Optional[Path] = None):
        ...
        if achievements_file is None:
            achievements_file = Path(__file__).parent.parent.parent / "data" / "achievements.json"
    ...
    def _load_achievements(self) -> List[Achievement]:
        ...
        for ach_def in self.ACHIEVEMENTS:
            ...
            achievement = Achievement(
                ...
                icon=ach_def['icon'],
                unlocked=saved.get('unlocked', False),
                unlocked_at=datetime.fromisoformat(saved['unlocked_at']) if 'unlocked_at' in saved else None,
    ...
    def update_progress(self, achievement_id: str, progress: float) -> Optional[Achievement]:
        """
    ...
    def check_session_achievements(self, session_count: int, total_hours: float,
                                   total_breaks: int, start_hour: int) -> List[Achievement]:
        """
