...
class BlinkRateChart(ctk.CTkFrame):
    ...
    def __init__(self, parent):
        ...
        self.line, = self.ax.plot([], [], color='#00ff88', linewidth=2, marker='o', markersize=4)
        
        # Add normal range indicator
        self.ax.axhspan(15, 20, alpha=0.1, color='#00ff88', label='Normal Range')
        self.ax.legend(loc='upper right', fontsize=8, facecolor='#16213e', edgecolor='#00ff88', labelcolor='#ffffff')
    ...
    def update_plot(self):
        ...
        if len(self.blink_rates) > 0:
            ...
            padding = (max_rate - min_rate) * 0.2 if max_rate != min_rate else 5
