...
class MainWindow(ctk.CTk):
    ...
    def _create_widgets(self):
        ...
        # ===== LEFT SIDEBAR =====
        sidebar = ctk.CTkFrame(self, width=200, corner_radius=0, fg_color="#1e293b")
        sidebar.grid(row=0, column=0, sticky="nswe", padx=0, pady=0)
        sidebar.grid_propagate(False)
        
        # Logo/Title in sidebar
        logo_frame = ctk.CTkFrame(sidebar, fg_color="#0f172a", corner_radius=0, height=100)
        ...
        # Separator
        ctk.CTkFrame(sidebar, height=2, fg_color="#3b82f6").pack(fill="x", pady=(0, 20))
        ...
        # ===== MAIN CONTENT AREA =====
        main_container = ctk.CTkFrame(self, fg_color="#0f172a", corner_radius=0)
        main_container.grid(row=0, column=1, sticky="nsew")
        main_container.grid_columnconfigure(0, weight=1)
        main_container.grid_rowconfigure(2, weight=1)  # Content row now at index 2
        
        # Top bar with gradient effect
        top_bar = ctk.CTkFrame(main_container, height=80, corner_radius=0, fg_color="#1e293b")
        ...
        breadcrumb_bar = ctk.CTkFrame(main_container, height=35, corner_radius=0, fg_color="#1e293b")
        breadcrumb_bar.grid(row=1, column=0, sticky="ew", padx=0, pady=0)
        breadcrumb_bar.grid_propagate(False)
        
        # Breadcrumb path
        self.breadcrumb_frame = ctk.CTkFrame(breadcrumb_bar, fg_color="transparent")
        ...
        breadcrumb_home.bind("<Button-1>", lambda e: self._switch_page("Dashboard"))
        breadcrumb_home.bind("<Enter>", lambda e: breadcrumb_home.configure(text_color="#2563eb"))
        breadcrumb_home.bind("<Leave>", lambda e: breadcrumb_home.configure(text_color="#3b82f6"))
    ...
    def _create_dashboard_page(self):
        ...
        self.dashboard = Dashboard(page, on_navigate=lambda: self._switch_page("Analytics"))
    ...
    def _create_analytics_page(self):
        ...
        activity_container = ctk.CTkFrame(page, fg_color="#1e293b", corner_radius=14, border_width=1, border_color="#334155")
        activity_container.grid(row=0, column=0, sticky="nsew", padx=(0, 4), pady=(0, 4))
        ...
        fatigue_container = ctk.CTkFrame(page, fg_color="#1e293b", corner_radius=14, border_width=1, border_color="#334155")
        fatigue_container.grid(row=0, column=1, sticky="nsew", padx=(4, 0), pady=(0, 4))
        ...
        keystroke_container = ctk.CTkFrame(page, fg_color="#1e293b", corner_radius=14, border_width=1, border_color="#334155")
        keystroke_container.grid(row=1, column=0, sticky="nsew", padx=(0, 4), pady=(4, 0))
        ...
        mouse_container = ctk.CTkFrame(page, fg_color="#1e293b", corner_radius=14, border_width=1, border_color="#334155")
        mouse_container.grid(row=1, column=1, sticky="nsew", padx=(4, 0), pady=(4, 0))
        ...
        blink_container = ctk.CTkFrame(page, fg_color="#1e293b", corner_radius=14, border_width=1, border_color="#334155")
        blink_container.grid(row=2, column=0, columnspan=2, sticky="nsew", pady=(8, 0))
    ...
    def _create_statistics_page(self):
        ...
        placeholder = ctk.CTkFrame(page, fg_color="#334155", corner_radius=12, border_width=1, border_color="#475569")
    ...
    def _create_settings_page(self):
        ...
        title_frame.grid(row=0, column=0, columnspan=3, sticky="ew", padx=10, pady=(10, 5))
        ...
        work_section = ctk.CTkFrame(page, fg_color="#334155", corner_radius=10, border_width=1, border_color="#475569")
        work_section.grid(row=1, column=0, sticky="nsew", padx=(5, 3), pady=(2, 2))
        ...
        self.work_interval_var = ctk.StringVar(value=str(self.config_manager.get('work_interval_minutes', 50)))
        ...
        break_section = ctk.CTkFrame(page, fg_color="#334155", corner_radius=10, border_width=1, border_color="#475569")
        ...
        self.break_interval_var = ctk.StringVar(value=str(self.config_manager.get('break_interval_minutes', 10)))
        ...
        monitor_section = ctk.CTkFrame(page, fg_color="#334155", corner_radius=10, border_width=1, border_color="#475569")
        monitor_section.grid(row=1, column=2, sticky="nsew", padx=(3, 5), pady=(2, 2))
        ...
        self.track_keyboard_var = ctk.BooleanVar(value=self.config_manager.get('monitoring.track_keyboard', True))
        ctk.CTkCheckBox(
            monitor_section,
            text="Track Keyboard",
        ...
        self.track_mouse_clicks_var = ctk.BooleanVar(value=self.config_manager.get('monitoring.track_mouse_clicks', True))
        ctk.CTkCheckBox(
            monitor_section,
        ...
        self.track_mouse_movement_var = ctk.BooleanVar(value=self.config_manager.get('monitoring.track_mouse_movement', False))
        ctk.CTkCheckBox(
            monitor_section,
        ...
        alerts_section = ctk.CTkFrame(page, fg_color="#334155", corner_radius=10, border_width=1, border_color="#475569")
        alerts_section.grid(row=2, column=0, sticky="nsew", padx=(5, 3), pady=2)
        ...
        self.break_alerts_var = ctk.BooleanVar(value=self.config_manager.get('alerts.enable_break_reminders', True))
        ctk.CTkCheckBox(
            alerts_section,
        ...
        self.fatigue_alerts_var = ctk.BooleanVar(value=self.config_manager.get('alerts.enable_fatigue_alerts', True))
        ctk.CTkCheckBox(
            alerts_section,
        ...
        self.alert_cooldown_var = ctk.StringVar(value=str(self.config_manager.get('alerts.alert_cooldown_minutes', 10)))
        cooldown_frame = ctk.CTkFrame(alerts_section, fg_color="transparent")
        cooldown_frame.pack(fill="x", padx=15, pady=(5, 15))
        
        ctk.CTkLabel(cooldown_frame, text="Alert Cooldown (minutes):").pack(side="left")
        ...
        eye_section = ctk.CTkFrame(page, fg_color="#334155", corner_radius=10, border_width=1, border_color="#475569")
        ...
        self.eye_tracking_var = ctk.BooleanVar(value=self.config_manager.get('eye_tracking.enabled', False))
        ctk.CTkCheckBox(
            eye_section,
        ...
        theme_section = ctk.CTkFrame(page, fg_color="#334155", corner_radius=10, border_width=1, border_color="#475569")
        ...
        button_frame.grid(row=3, column=0, columnspan=3, sticky="ew", padx=10, pady=(5, 5))
    ...
    def _create_about_page(self):
        ...
        # Version info card
        version_frame = ctk.CTkFrame(page, fg_color="#2d3548", corner_radius=16, border_width=0)
        ...
        # Features section
        features_frame = ctk.CTkFrame(page, fg_color="#2d3548", corner_radius=16, border_width=0)
        ...
        # Technology stack
        tech_frame = ctk.CTkFrame(page, fg_color="#334155", corner_radius=10, border_width=1, border_color="#475569")
        ...
        for tech_name, url in tech_links:
            ...
            # Hover effect
            link_label.bind("<Enter>", lambda e, lbl=link_label: lbl.configure(text_color="#2563eb"))
            link_label.bind("<Leave>", lambda e, lbl=link_label: lbl.configure(text_color="#3b82f6"))
        
        ctk.CTkLabel(tech_frame, text="").pack(pady=5)  # Spacing
        
        # Privacy & Data
        privacy_frame = ctk.CTkFrame(page, fg_color="#334155", corner_radius=10, border_width=1, border_color="#475569")
        ...
        # Credits & License
        credits_frame = ctk.CTkFrame(page, fg_color="#334155", corner_radius=10, border_width=1, border_color="#475569")
    ...
    def _switch_page(self, page_name):
        ...
        if page_name in self.pages:
            ...
            icons = {"Dashboard": "📊", "Analytics": "📈", "Statistics": "🎯", "Settings": "⚙️", "About": "ℹ️"}
            colors = {"Dashboard": "#3b82f6", "Analytics": "#14b8a6", "Statistics": "#8b5cf6", "Settings": "#f97316", "About": "#3b82f6"}
    ...
    def _update_ui(self):
        ...
        try:
            ...
            try:
                ...
                self.keystroke_history = [(t, v) for t, v in self.keystroke_history if t >= cutoff]
                ...
                self.mouse_history = [(t, v) for t, v in self.mouse_history if t >= cutoff]
...
Great work! Remember to take regular breaks.
    ...
    def _save_inline_settings(self):
        ...
        try:
            ...
            self.config_manager.set('monitoring.track_keyboard', self.track_keyboard_var.get())
            self.config_manager.set('monitoring.track_mouse_clicks', self.track_mouse_clicks_var.get())
            self.config_manager.set('monitoring.track_mouse_movement', self.track_mouse_movement_var.get())
            
            self.config_manager.set('alerts.enable_break_reminders', self.break_alerts_var.get())
            self.config_manager.set('alerts.enable_fatigue_alerts', self.fatigue_alerts_var.get())
            self.config_manager.set('alerts.alert_cooldown_minutes', cooldown_minutes)
            
            self.config_manager.set('ui.theme', self.theme_var.get())
            
            self.config_manager.set('eye_tracking.enabled', self.eye_tracking_var.get())
            ...
            messagebox.showerror("Invalid Input", "Please enter valid positive numbers for all numeric fields.")
        except Exception as e:
    ...
    def _reset_settings(self):
        ...
        if messagebox.askyesno("Reset Settings", "Are you sure you want to reset all settings to defaults?"):
            try:
                ...
                messagebox.showinfo("Settings Reset", "Settings have been reset to defaults. Click Save to apply.")
            except Exception as e:
