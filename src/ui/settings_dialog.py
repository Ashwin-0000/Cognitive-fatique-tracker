...
class SettingsDialog(ctk.CTkToplevel):
    ...
    def __init__(self, master, config_manager, on_save: Optional[Callable] = None):
    ...
    def _load_current_settings(self):
        ...
        self.work_interval_var.set(str(self.config_manager.get('work_interval_minutes', 50)))
        self.break_interval_var.set(str(self.config_manager.get('break_interval_minutes', 10)))
        
        self.track_keyboard_var.set(self.config_manager.get('monitoring.track_keyboard', True))
        self.track_mouse_clicks_var.set(self.config_manager.get('monitoring.track_mouse_clicks', True))
        self.track_mouse_movement_var.set(self.config_manager.get('monitoring.track_mouse_movement', False))
        
        self.break_alerts_var.set(self.config_manager.get('alerts.enable_break_reminders', True))
        self.fatigue_alerts_var.set(self.config_manager.get('alerts.enable_fatigue_alerts', True))
        self.alert_cooldown_var.set(str(self.config_manager.get('alerts.alert_cooldown_minutes', 10)))
        
        self.theme_var.set(self.config_manager.get('ui.theme', 'dark'))
        
        self.eye_tracking_var.set(self.config_manager.get('eye_tracking.enabled', False))
