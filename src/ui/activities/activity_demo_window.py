...
class ActivityDemoWindow(ctk.CTkToplevel):
    ...
    def _create_widgets(self):
        ...
        # ===== MAIN CONTENT AREA: LEFT SIDE (INSTRUCTIONS) | RIGHT SIDE (ANIMATION) =====
        ...
        inst_frame = ctk.CTkFrame(left_panel, corner_radius=16, fg_color="#161b22", border_width=1, border_color="#21262d")
        ...
        benefits_frame = ctk.CTkFrame(left_panel, corner_radius=16, fg_color="#1a1f26", border_width=1, border_color="#30363d")
        ...
        # Animation canvas
        self.animation_frame = ctk.CTkFrame(right_panel, corner_radius=20, fg_color="#161b22", border_width=1, border_color="#21262d")
    ...
    def _start_activity(self):
        ...
        if not self.is_running:
            ...
            self.start_btn.configure(text="▶  Running...", state="disabled", fg_color="#6b7280")
    ...
    def _pause_activity(self):
        ...
        if self.is_running:
            ...
            self.start_btn.configure(text="⏸  Paused", state="normal", fg_color="#6b7280")
    ...
    def _reset_activity(self):
        ...
        self.timer_display.configure(text=self._format_time(self.time_remaining))
        self.progress_bar.set(0)
        self.cycle_label.configure(text=f"Cycle {self.current_cycle + 1} of {self.total_cycles}")
        self.start_btn.configure(text="▶  Start Activity", state="normal", fg_color="#10b981")
        self.pause_btn.configure(text="⏸  Pause", state="disabled", fg_color="#6b7280")
        ...
        self.canvas.itemconfig(self.circle_id, fill="#10b981", outline="#34d399")
    ...
    def _animate_breathing(self):
        ...
        if self.breath_phase >= 1:
            ...
            self.breath_cue_label.configure(text="Breathe Out Slowly...", text_color="#f59e0b")
            self.breath_instruction.configure(text="Exhale gently through your mouth (6 seconds)")
        elif self.breath_phase <= 0:
            self.breath_phase = 0
            self.breath_direction = 1
            self.breath_cue_label.configure(text="Breathe In Deeply...", text_color="#10b981")
            self.breath_instruction.configure(text="Take a deep breath through your nose (4 seconds)")
        ...
        if self.breath_direction == 1:  # Inhale
            ...
            self.canvas.itemconfig(self.circle_id, fill="#f59e0b", outline="#fbbf24")
    ...
    def _toggle_audio(self):
        ...
        if "🔊" in current_text:
            ...
            self.audio_btn.configure(text="🔊  Audio Guide", fg_color="transparent")
    ...
    def _on_complete(self):
        ...
        self.start_btn.configure(text="✅ Completed", state="disabled", fg_color="#10b981")
        self.pause_btn.configure(state="disabled")
        self.breath_cue_label.configure(text="Activity Complete! 🎉", text_color="#10b981")
        self.breath_instruction.configure(text="Great work! You should feel refreshed.")
