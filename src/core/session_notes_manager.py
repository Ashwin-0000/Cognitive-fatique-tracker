...
class SessionNotesManager:
    ...
    def __init__(self, notes_file: Optional[Path] = None):
        ...
        if notes_file is None:
            notes_file = Path(__file__).parent.parent.parent / \
                "data" / "session_notes.json"
    ...
    def add_session_note(self, session_id: str, note: str,
        ...
        if tags:
            ...
            self.notes_data['sessions'][session_id]['tags'] = list(
                current_tags)
    ...
    def get_session_notes(self, session_id: str) -> Dict:
        ...
        return self.notes_data['sessions'].get(
            session_id, {'notes': [], 'tags': []})
